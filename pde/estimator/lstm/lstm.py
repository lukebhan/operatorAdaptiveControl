...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        h0 = torch.zeros(self.num_layersLstm, batch_size, self.hidden_size, device=x.device)
        c0 = torch.zeros(self.num_layersLstm, batch_size, self.hidden_size, device=x.device)
